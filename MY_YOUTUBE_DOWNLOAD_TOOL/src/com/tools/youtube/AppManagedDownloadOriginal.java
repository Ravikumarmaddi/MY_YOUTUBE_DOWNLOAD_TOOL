...
public class AppManagedDownloadOriginal {
    ...
    public static void main(String[] args) {
        ...
        String url = "https://www.youtube.com/watch?v=gDVBvvPlOE4&list=PLWUvWgxGsU5U0TINPU1MLz4GC_1uucDUN&index=2";//args[0];
        // ex: /Users/axet/Downloads/
        String path = "C:/YoutudeDownload"; //args[1];
